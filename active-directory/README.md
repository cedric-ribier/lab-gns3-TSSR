...
> Script complet disponible dans [`../powershell/`](https://github.com/lab-gns3-TSSR/scripts/powershell/) et dans le repo [`Powershell-scripts`](https://github.com/cedric-ribier/Powershell-scripts)
